subroutine VTK_debug (geometry,delaunay,params,network,stack,erodeit, label, step)
!
...
! the step is an integer, label is a string without any length limit, @YWANG, May 2023
  ...
  double precision, intent(in) :: erodeit(geometry%nnode) ! nodal attribute to write
...
!!$  print*, 'minprecipitation is',  min_precipitation 
  ...
  write(30,'(a)')'SCALARS lakefill float 1'
  write (30,'(a)')'LOOKUP_TABLE default'
  do i=1,geometry%nnode
     write(30,'(e12.4)') erodeit(i)
  enddo
