subroutine output_z_tau (params,geometry,network,stack)
  ...
  double precision deltaz, deltachi
  ...
  do i=1,geometry%nnode
      write(75,'(f8.3,f15.3,f15.3,f15.5, i7, f15.1)') geometry%z(i), tau(i),  geometry%chi(i), ks(i), geometry%catchment(i), contributing_area(i)
  enddo
  close (75)
  ...
  do i =1,geometry%ndivide
     ...
     write(78,'(i5, i5, e12.4, e12.4)') node1, node2, geometry%chi(node1), geometry%chi(node2)
