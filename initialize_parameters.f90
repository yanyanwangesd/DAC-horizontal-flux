...
k=params%k_scalar1
slope=(u/(k*params%xc**(params%h*params%m)*p**params%m*params%ka**params%m))**(1./params%n) ! SS state channel head slope
slope=180*atan(slope)/3.141592
sloped=u*params%xc/(params%diffusivity/2.)
sloped_total=u*params%xc/(params%diffusivity) ! SS state maximum diffusive slope 
