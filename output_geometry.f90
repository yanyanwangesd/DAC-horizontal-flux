subroutine output_geometry (geometry,params,network,delaunay)
 ...
 enddo
  ...
  enddo
  do i = 1,geometry%ndivide
     write(50) geometry%nndivnode(i,1), geometry%nndivnode(i,2), geometry%nndivtri(i,1),geometry%nndivtri(i,2)
  enddo
  ...
  enddo
  do i=1,geometry%nnode
     write(50) geometry%fix(i)
  enddo
  
  !!@YWANG, Jan. 2022
  do i=1,geometry%nnode
     write(50) geometry%card_flow(i)
  enddo
  do i=1,geometry%nnode
     write(50) geometry%jitter_flag(i,1), geometry%jitter_flag(i,2),geometry%jitter_flag(i,3)
  enddo
  do i=1,geometry%nnode
     write(50) geometry%jitter_residual(i)
  enddo

  ! !
  do i=1,geometry%nnode
     write(50) geometry%u(i)
  enddo
  do i=1,geometry%nnode
     write(50) geometry%v(i)
  enddo
  do i=1,geometry%nnode
     write(50) geometry%w(i)
  enddo
